...
//            new Endpoint("/api/gallery/{id}", MethodType.GET),
...
//            new Endpoint("/api/rooms", MethodType.GET),
//            new Endpoint("/api/room/{id}", MethodType.GET),
//            new Endpoint("/api/artworks", MethodType.GET),
//            new Endpoint("/api/artwork/{id}", MethodType.GET)
//    );
//
